...
namespace CFBProfilePlugin
{
    public class CollegeFootball27Profile : IProfile
    {
    ...
    public class CollegeFootball27TrialProfile : CollegeFootball27Profile
    {
    ...
    public class CollegeFootball27CompressionUtils : ICompressionUtils
    {
